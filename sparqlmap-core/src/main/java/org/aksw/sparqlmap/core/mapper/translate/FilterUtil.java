...
public abstract class FilterUtil {
	...
	public static FromItem getOtherFromItem(EqualsTo equalsTo, FromItem fi) {
		...
		FromItem fi1 = null;
		if(DataTypeHelper.uncast(equalsTo.getLeftExpression()) instanceof Column){
			fi1 = ((Column)DataTypeHelper.uncast(equalsTo.getLeftExpression())).getTable();
		}
		FromItem fi2 = null;
		if(DataTypeHelper.uncast(equalsTo.getRightExpression()) instanceof Column){
			fi2 = ((Column)DataTypeHelper.uncast(equalsTo.getRightExpression())).getTable();
		}
