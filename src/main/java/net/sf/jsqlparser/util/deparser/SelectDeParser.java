...
public class SelectDeParser implements SelectVisitor, OrderByVisitor, SelectItemVisitor, FromItemVisitor, ColumnReferenceVisitor {
	...
	public void visit(OrderByElement orderBy) {
		...
		if(orderBy instanceof OrderByExpressionElement){
			Expression expr = ((OrderByExpressionElement) orderBy).getExpression();
	...
	public void visit(Table tableName) {
		if(tableName.getWholeTableName()!=null){
			buffer.append(tableName.getWholeTableName());
		}
//		if(tableName.getAlias()!=null){
//			buffer.append(" AS " + tableName.getAlias());
//		}
