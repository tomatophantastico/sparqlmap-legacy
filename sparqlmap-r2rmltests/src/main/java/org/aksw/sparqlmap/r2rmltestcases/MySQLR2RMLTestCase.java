...
public class MySQLR2RMLTestCase extends R2RMLTest {
	...
	@Before
	public void before(){
		connector = new MySQLConnector(getDBProperties().getProperty("jdbc.url"),getDBProperties().getProperty("jdbc.username"),getDBProperties().getProperty("jdbc.password"),1,2);
	}
