...
public class SparqlMapContextLoader implements ApplicationContextInitializer<ConfigurableWebApplicationContext>{
	...
	public void initialize(ConfigurableWebApplicationContext applicationContext) {
		...
		if(sparqlMapHome!=null){
			...
			throw new ImplementationException("Implemenet classpath lookup");
